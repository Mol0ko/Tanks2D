...
namespace Tanks2D.Utils
{
    ...
    public static class MoveExtensions
    {
        ...
        public static MoveDirection GetMoveDirectionFromDirection(this Vector3 vector) 
            => _directions.FirstOrDefault(pair => pair.Value == vector).Key;
        public static MoveDirection GetMoveDirectionFromRotation(this Vector2 vector)
        {
            var vector3 = (Vector3)vector;
            return _directions.FirstOrDefault(pair => pair.Value == vector3).Key;
        }
        public static MoveDirection GetMoveDirectionFromRotation(this Vector3 vector) 
            => _rotations.FirstOrDefault(pair => pair.Value == vector).Key;
    }
}
